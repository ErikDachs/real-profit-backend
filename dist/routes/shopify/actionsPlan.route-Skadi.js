...
export function registerActionsPlanRoute(app, ctx) {
        ...
        try {
            ...
            for (const o of orders) {
                ...
                orderProfits.push({
                    ...
                    // ✅ FIX 2 (wichtig für computeOrderReasons / insights)
            ...
            const unifiedAll = (insights?.unifiedOpportunitiesAll ?? []);
            const unifiedTop = (insights?.unifiedOpportunitiesTop5 ?? []);
            // 6) Scenario sims
            ...
            for (const [t, s] of scenarioByType.entries())
                simulationByType.set(t, s);
            ...
            return reply.send({
                ...
                opportunities: insights?.opportunities ?? null,
