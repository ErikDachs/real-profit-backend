...
export async function calculateOrderProfit(params) {
    ...
    const excludeGiftCards = Boolean(costProfile?.flags?.excludeGiftCards ?? false);
    ...
    const shippingCostPerOrder = includeShippingCost && !isGiftCardOnlyOrder ? Number(costProfile.shipping?.costPerOrder || 0) : 0;
    ...
    return {
        ...
        breakEvenRoas: breakEvenRoas === null ? null : typeof breakEvenRoas === "number" ? round2(breakEvenRoas) : breakEvenRoas,
