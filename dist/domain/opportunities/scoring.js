 ...
 */
export function controllabilityForType(type) {
    switch (type) {
        case "MISSING_COGS":
            return 1.0;
        case "HIGH_FEES":
 ...
 */
export function confidenceForOpportunity(opp) {
    ...
    if (opp.type === "MISSING_COGS" && Number(meta.missingCogsCount || 0) > 0)
        bump += 0.05;
 ...
 */
export function severityForMonthlyLoss(monthlyLoss) {
