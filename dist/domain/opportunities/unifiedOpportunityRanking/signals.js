...
export function addProfitImpactSignals(out, params, base) {
...
export function addRefundSignals(out, params, base) {
    const { days, currency } = base;
    if (!params.refunds)
        return;
    out.push(mk({
...
export function addFeeSignals(out, params, base) {
    const { days, currency } = base;
    if (!params.fees)
        return;
    out.push(mk({
...
export function addMissingCogsSignals(out, params, base) {
    const { days, currency } = base;
...
export function addShippingSignals(out, params, base) {
    const { days, currency } = base;
...
export function addMarginDriftSignals(out, params, base) {
    const { days, currency } = base;
...
export function addBreakEvenRiskSignals(out, params, base) {
    const { days, currency } = base;
...
export function addFixedCostSignals(out, params, base) {
    const { days, currency } = base;
